...
*/
/* jquery-core: (https://5b6d6cca63736.t73.qifeiye.com/qfy-includes/js/jquery/jquery.js) */
...
/* jquery-migrate: (https://5b6d6cca63736.t73.qifeiye.com/qfy-includes/js/jquery/jquery-migrate.min.js) */
...
var dtGlobals = {};
dtGlobals.isMobile = /(Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini|windows phone)/.test(
  navigator.userAgent
);
...
jQuery(document).ready(function ($) {
  ...
  if (!$("html").hasClass("old-ie")) {
    ...
    try {
      var size = top.window
        .getComputedStyle(top.document.body, ":after")
...
/* qfe_composer_front_js: (https://5b6d6cca63736.t73.qifeiye.com/qfy-content/plugins/qfy_editor/assets/js/qfy_editor_front.js) */
...
function vc_js_init() {
  ...
  if (!is_edit_model) {
    if (
      jQuery(".qfy-element.qfy-slidercontent").length > 0 &&
      jQuery("a[href^='qfylinked_']").length > 0
    ) {
      jQuery("a[href^='qfylinked_']:not(.loaded)").each(function () {
        ...
        if (url.indexOf("^") > -1) {
          ...
          if (uuid) {
            var obj = jQuery(
              "[qfyuuid='" + uuid + "']>.royalSlider_gallery_new"
            );
            if (obj.length > 0) {
              if (type == "1") {
                jQuery(this)
    ...
    //
    if (
      jQuery(".qfy-element.qfe_gallery").length > 0 &&
      jQuery("a[href^='qfyrelaed_']").length > 0
    ) {
          ...
          if (uuid) {
            if (type == "1") {
              jQuery(this)
                ...
                .mouseenter(function (e) {
                  var obj = jQuery(
                    "[qfyuuid='" + uuid + "'] .royalSlider_gallery"
                  );
                  if (obj.length > 0) {
                    var slider = obj.data("royalSlider");
                    slider.goTo(to - 1);
                  } else if (
                    jQuery("[qfyuuid='" + uuid + "'] .qfe_flexslider").length >
                    0
                  ) {
                    jQuery(
                      "[qfyuuid='" + uuid + "'] .qfe_flexslider"
                    ).flexslider(to - 1);
                  } else if (
                    jQuery("[qfyuuid='" + uuid + "'] .swiper-container")
                      .length > 0
                  ) {
                    jQuery("[qfyuuid='" + uuid + "'] .swiper-container")
                      .data("swiper")
              ...
              jQuery(this).click(function (e) {
                ...
                if (obj.length > 0) {
                  ...
                  jQuery("[qfyuuid='" + uuid + "'] .qfe_flexslider").length > 0
                ) {
                  jQuery("[qfyuuid='" + uuid + "'] .qfe_flexslider").flexslider(
                    to - 1
                  );
                } else if (
                  jQuery("[qfyuuid='" + uuid + "'] .swiper-container").length >
                  0
                ) {
                  jQuery("[qfyuuid='" + uuid + "'] .swiper-container")
                    .data("swiper")
  ...
  if (jQuery(".swiper-container:not(.loaded)").length > 0) {
    if (typeof jQuery.fn.Swiper == "undefined") {
      jQuery
        .getScript("/FeiEditor/bitSite/js/swiper/swiper-4.1.0.min.js")
        .done(function () {
          jQuery("head").append(
  ...
  jQuery(".srollupdown:not(.load)").each(function () {
    ...
    var s = function () {
      slideBox.attr(
        "style",
        "overflow:hidden !important;height:" + allheight + "px;"
      );
      ...
      if (num > 1) {
        ...
        slideBox.find("li").each(function (i) {
          if (i < num) {
            first_height =
              first_height * 1 +
              jQuery(this).css("height").replace("px", "") * 1;
            marginbottom =
              marginbottom * 1 +
              jQuery(this).css("margin-bottom").replace("px", "") * 1;
          }
        });
      } else {
        var first_height = slideBox
          .find("li:eq(0)")
          .css("height")
          .replace("px", "");
        var marginbottom = slideBox
          .find("li:eq(0)")
          .css("margin-bottom")
          .replace("px", "");
      }
  ...
  jQuery(".qfy_datatable_event:not(.loaded)").each(function () {
    ...
    if (typeof jQuery.fn.DataTable == "undefined") {
      jQuery
        .getScript("/FeiEditor/bitSite/js/dataTables/jquery.dataTables.js")
        .done(function () {
  ...
  jQuery(".opentip:not(.played)").each(function () {
    ...
    if (title) {
      tiptitle +=
        "<div style='margin-top:5px;text-align:" +
        titlealign +
        "'>" +
        title +
        "</div>";
  ...
  if (jQuery(".qfy-jiathis").length > 0) {
    if (typeof jQuery.fn.share != "function") {
      jQuery.getScript("./jquery.share.min.js").done(function () {
        jQuery("head").append(
    ...
    if (pcontent.hasClass("mo")) {
      curr.unbind().bind("mouseenter", function (e) {
        ...
        if (hc == "true" && !curr.hasClass("active")) {
          p.find(".a_content>section,.a_content>div").slideUp(
            animation,
            function () {
              var now = jQuery(this);
              ...
              now
                .prev()
                .find("i")
                .attr("class", normalicon)
                .css("font-size", p.attr("data-normalicon-size") + "px")
                .css("left", p.attr("data-normalicon-position") + "px")
                .css("top", p.attr("data-normalicon-pt") + "px");
        ...
        if (display == "none") {
          ...
          n.slideDown(animation, function () {
            ...
            if (
              jQuery("body").width() < 760 &&
              !curr.hasClass("defaultclick")
            ) {
            ...
            if (n.find(".qfe_map_wraper iframe").length > 0) {
              n.find(".qfe_map_wraper iframe").attr(
                "src",
                n.find(".qfe_map_wraper iframe").attr("src")
              );
            }
          });
          curr
            .find("i")
            .attr("class", activeicon)
            .css("font-size", p.attr("data-activeicon-size") + "px")
            .css("left", p.attr("data-activeicon-position") + "px")
            .css("top", p.attr("data-activeicon-pt") + "px");
  ...
  jQuery(".qfy-accordioncontent:not(.loaded)").each(function () {
    ...
    if (accordion_default > 0) {
      var defaultobj = jQuery(this).find(
        ".a_content .panel-title:eq(" + (accordion_default - 1) + ")"
      );
  ...
  jQuery(".dl-qfymobile-menu:not(.loaded)").each(function () {
    ...
    jQuery(this)
      .find(".children.dl-submenu")
      .prepend(
        "<li class='menu-item dl-back'><a href='#'><span>" +
          backCap +
          "</a></li>"
      );
  ...
  if (!is_edit_model) {
    jQuery(".background-media.mediagallery:not(.loaded)").each(function () {
      ...
      setInterval(function () {
        if (p.attr("id")) {
          imagebgs_current = p
            .find(".background-media.On")
            .index("#" + p.attr("id") + ">.background-media");
        } else {
          ...
          if (currclass) {
            imagebgs_current = p
              .find(".background-media.On")
              .index("." + currclass + " .background-media");
          } else {
            imagebgs_current = p
              .find(".background-media.On")
              .index(".background-media");
          }
        }
        ...
        if (imagebgs_current == imagebgs_count - 1) {
          ...
          p.find(".background-media:eq(" + (imagebgs_current + 1) + ")")
            .addClass("On")
            .css({
              opacity: "1",
            });
    ...
    if (image) {
      if (width) {
        var title =
          ...
          "'><img src='" +
          image +
          "' style='max-width:100%;' /><div style='word-break: break-all;'>" +
          text +
          "</div></div>";
      } else {
        var title =
          ...
          " '><img src='" +
          image +
          "' width='160' style='max-width:100%;' /><div style='word-break: break-all;'>" +
          text +
          "</div></div>";
      }
      var img = new Image();
    ...
    jQuery(this).waypoint({
      handler: function (direction) {
        ...
        jQuery(this)
          ...
          .css("animation-name", animalename)
...
jQuery(window).resize(function () {
  ...
  var maxwidth = 0;
  jQuery(".qfe_gallery .qfe_gallery_slides")
    .find("img")
    .each(function () {
...
function resizefullpageheader() {
  if (
    jQuery(".bit-html .fullscreenpage.fullpage_layout2").length > 0 ||
    jQuery(".bit-html .fullscreenpage.fullpage_layout3").length > 0 ||
    jQuery(".bit-html .fullscreenpage.fullpage_layout4").length > 0
  ) {
    jQuery(".bit-html .fullscreenpage #fullscreenheader").css(
      "margin-top",
      "-" +
        jQuery(".bit-html .fullscreenpage #fullscreenheader").height() / 2 +
        "px"
    );
  }
}
...
function bit_circliful(obj) {
  ...
  if (typeof jQuery.fn.circliful == "undefined") {
    jQuery
      .getScript("/qfy-content/plugins/qfy_editor/js/jquery.circliful.min.js")
      .done(function () {
        _bit_circliful(obj);
      });
  } else {
...
function _bit_circliful(obj) {
  "undefined" != typeof jQuery.fn.waypoint &&
    "undefined" != typeof jQuery.fn.circliful &&
    obj.each(function () {
...
function bit_counter(obj) {
  ...
  if (typeof jQuery.fn.countTo == "undefined") {
    jQuery
      .getScript("/qfy-content/plugins/qfy_editor/js/jquery.countto.min.js")
      .done(function () {
        _bit_counter(obj);
      });
  } else {
...
function bit_newgallery(obj) {
  ...
  if (typeof jQuery.fn.royalSlider == "undefined") {
    jQuery.getScript("/js/jquery.royalslider.min.js").done(function () {
      _bit_newgallery(obj);
    });
  } else {
    _bit_newgallery(obj);
...
function bit_myaccountLayout() {
  ...
  if (
    jQuery(".qfy_account.tablayout").length > 0 &&
    jQuery(".qfy_account.tablayout.ontab").length == 0
  ) {
    ...
    jQuery(".qfy_account .my_account_orders_h2").each(function (i) {
      ...
      if (
        content.hasClass("my_account_orders_h2") ||
        content.hasClass("bitcommerce-tabs-info") ||
        content.length == 0
      ) {
      ...
      jQuery(".bitcommerce-tabs-info ul.tabs").append(
        '<li class="description_tab active"><a href="#tab-info-' +
          i +
          '" class="no-opennew">' +
          name.text() +
          "</a></li>"
      ...
      jQuery(".bitcommerce-tabs-info ul.tabs").after(
        '<div style="word-break: break-all; display: block;" id="tab-info-' +
          i +
    ...
    if (titlesize) {
      jQuery(".bitcommerce-tabs-info ul.tabs li a").css(
        "font-size",
        titlesize + "px"
      );
    }
    ...
    if (defaultindex > 0) {
      jQuery(
        ".bitcommerce-tabs-info ul.tabs li:eq(" + defaultindex + ") a"
      ).click();
    } else {
...
function qfy_jplayer_init() {
  ...
  if (typeof jQuery.fn.videoPlayer == "undefined") {
    jQuery
      .when(
        jQuery.getScript(
          "/FeiEditor/bitSite/js/jsplayer/jplayer/jquery.jplayer.min.js"
        ),
        jQuery.getScript(
          "/FeiEditor/bitSite/js/jsplayer/jplayer/jplayer.cleanskin.js"
        ),
...
function bit_counterdown() {
  ...
  if (typeof jQuery.fn.countEverest == "undefined") {
    jQuery
      .getScript("/FeiEditor/bitSite/js/jquery.vcsc.counteverest.min.js")
      .done(function () {
        jQuery("head").append(
...
if (typeof window["vc_plugin_flexslider"] !== "function") {
  function vc_plugin_flexslider() {
    ...
    if (typeof jQuery.fn.flexslider == "undefined") {
      jQuery
        .getScript(
          "/qfy-content/plugins/qfy_editor/assets/lib/flexslider/jquery.flexslider-min.js"
        )
        .done(function () {
          jQuery("head").append(
...
function bit_product() {
  if (jQuery(".bitcommerce").length == 0) return false;
  // Tabs
  ...
  jQuery(".bitcommerce-main-image a")
    .removeAttr("href")
    .click(function () {
      jAlert("请在预览下，查看图片效果！");
    });
  jQuery(".button.add_to_cart_button,.button.product_type_simple")
    .removeAttr("href")
    .click(function () {
      jAlert(
        "编辑情况下，无法使用购物车功能。如果修改商城默认页面，你可以从左上角选择功能页面进行编辑！"
      );
    });
...
if (typeof window["vc_waypoints"] !== "function") {
  ...
  function qfy_animate_out($this) {
    ...
    jQuery($this)[0].addEventListener(
      qfy_animateEvent_end,
      function (e) {
  ...
  function vc_waypoints() {
    ...
    if (typeof jQuery.fn.waypoint !== "undefined") {
      jQuery(".qfe_animate_when_almost_visible:not(.qsa)").waypoint(
        function () {
    ...
    jQuery("[data-ani_c]").each(function () {
      ...
      var c_fun = function ($this) {
        ...
        jQuery($this).addClass(
          "qfe_" + jQuery($this).attr("data-ani_c") + "_c"
        );
    ...
    jQuery("[data-ani_h]").each(function () {
      ...
      var h_fun = function ($this) {
        ...
        jQuery($this).addClass(
          "qfe_" + jQuery($this).attr("data-ani_h") + "_h"
        );
    ...
    jQuery("[data-ani_l]").each(function () {
      ...
      var h_fun = function ($this) {
        ...
        jQuery($this).addClass(
          "qfe_" + jQuery($this).attr("data-ani_l") + "_l"
        );
  ...
  function vc_teaserGrid() {
    ...
    if (jQuery("body.compose-mode").length == 1) {
      ...
      if (!top.jQuery("body").hasClass("caterole")) {
        jQuery(".content-wrapper .vc-element .vc_ca_post_id")
          .mouseenter(function () {
            jQuery(this).css("outline", "2px dotted #5E87B0");
            if (jQuery(this).find(".vc_list_edit_button").length == 0) {
              if (
                jQuery(this).find(".blog-media .toEditor,#item_block .toEditor")
                  .length == 0
              ) {
                jQuery(this)
                  .find(".blog-media,#item_block")
                  .append(
                    "<span class='toEditor' ><span class='edit e_copy' style='display:inline' onclick='toCopy(this)'>复制</span><span class='edit e_edit' style='display:inline' onclick='toVisit(this)'>打开</span><!--<span class='edit e_delete' style='display:inline' onclick='toDelete(this)'>删除</span>--></span>"
                  );
              }
              if (jQuery(this).closest(".vc-element").attr("data-model-id")) {
                var editname = "更换图片";
                if (
                  jQuery(this).closest(".qfy-element").attr("data-post") ==
                  "attachment"
                ) {
                  editname = "编辑";
                }
                jQuery(this)
                  ...
                  .append(
                    "<span class='vc_list_edit_button vc_list_edit_action' style='display:inline;'><span style='display:inline;' onclick='toEditor(this,event)'>" +
                      editname +
                      "</span><span style='display:inline;' onclick='parent.toeditlistmore(this,event,\"vc_scrolllist_image_element\")' title='修改样式，格式'>设置</span>"
                  );
                jQuery(this)
                  .find(".item_img")
                  .append(
                    "<span class='vc_list_edit_button vc_list_edit_action' style='display:inline;'><span style='display:inline;' onclick='toEditor(this,event)'>" +
                      editname +
                      "</span><span style='display:inline;' onclick='parent.toeditlistmore(this,event,\"vc_advanced_image_element\")' title='修改样式，格式'>设置</span>"
                  );
                var p = jQuery(this);
                if (
                  p.find(".post-title").length > 0 &&
                  p.find(".post-title .vc_list_edit_action").length == 0
                ) {
                  var actionstr =
                    '<span class="fa fa-pencil vc_list_edit_action"  style="margin-left:10px;display:inline;" onclick="toEditor(this,event)" title="编辑"></span><span class="fa fa-cog vc_list_edit_action" style="margin-left:10px;display:inline;" onclick="parent.toeditlistmore(this,event,\'vc_advanced_list_title_element\')" title="修改样式，格式"></span>';
                  ...
                  if (p.find(".post-title >a").length > 0) {
                    ...
                    if (title.html() && title.html().length > 15) {
                      var newtitle = title
                        .html()
                        .substr(0, title.html().length - 6);
                      title.html(
                        "<span class='hidetitle' style='display:none'>" +
                          title.html() +
                          "</span><span class='edittitle' >" +
                          newtitle +
                          "</span>"
                      );
                    }
                ...
                if (
                  p.find(".post_excerpt").length > 0 &&
                  p.find(".post_excerpt .vc_list_edit_action").length == 0
                ) {
                  var actionstr =
                ...
                if (
                  jQuery(this).find(".title").length > 0 &&
                  jQuery(this).find(".title .vc_list_edit_action").length == 0
                ) {
                  var actionstr =
                ...
                if (
                  jQuery(this).find(".details").length > 0 &&
                  jQuery(this).find(".details .vc_list_edit_action").length == 0
                ) {
                  var actionstr =
                    '<span class="fa fa-cog vc_list_edit_action" style="margin-left:10px;display:inline;z-index:2;position:relative;" onclick="parent.toeditlistmore(this,event,\'vc_advanced_list_details_element\')" title="修改样式，格式"></span>';
                  jQuery(this).find(".details").append(actionstr);
                }
                if (
                  jQuery(this).find(".subtitle").length > 0 &&
                  jQuery(this).find(".subtitle .vc_list_edit_action").length ==
                    0
                ) {
                  var actionstr =
                    '<span class="fa fa-cog vc_list_edit_action" style="margin-left:10px;display:inline;z-index:2;position:relative;" onclick="parent.toeditlistmore(this,event,\'vc_advanced_list_subtitle_element\')" title="修改样式，格式"></span>';
                  jQuery(this).find(".subtitle").append(actionstr);
                }

                if (
                  jQuery(this).find(".post_date").length > 0 &&
                  jQuery(this).find(".post_date .vc_list_edit_action").length ==
                    0
                ) {
                  var actionstr =
                    '<span class="fa fa-cog vc_list_edit_action" style="margin-left:10px;display:inline;z-index:2;position:relative;" onclick="parent.toeditlistmore(this,event,\'vc_advanced_list_postdate_element\')" title="修改样式，格式"></span>';
                  jQuery(this).find(".post_date").append(actionstr);
                }

                if (
                  jQuery(this).find(".price_warp").length > 0 &&
                  jQuery(this).find(".price_warp .vc_list_edit_action")
                    .length == 0
                ) {
                  ...
                  var actionstr =
                    ...
                    current_pid +
                    ',\'设置商品\', \'product\');" title="编辑"></span><span class="fa fa-cog vc_list_edit_action" style="margin-left:10px;display:inline;z-index:2;position:relative;" onclick="parent.toeditlistmore(this,event,\'vc_advanced_list_price_element\')" title="修改样式，格式"></span>';
        ...
        if (jQuery(".product-content.single-product").length == 0) {
          jQuery(".bitcommerce-main-image,.wd_product_wrapper .product_a")
            .mouseenter(function () {
              jQuery(this)
                .removeAttr("href")
                .append(
                  "<span class='toEditor' style='right:0;width:100px;'><span class='edit' style='display:inline' onclick='toEditProduct(this)'><i class='glyphicon glyphicon-edit'></i>数据</span><span style='display:inline' class='delete' onclick='toRedirectProduct(this)'><i class='glyphicon glyphicon-forward'></i>页面</span></span>"
                );
            })
            .mouseleave(function () {
    ...
    jQuery(
                ...
                if ($container.closest(".vc-element").attr("data-model-id")) {
                  ...
                  jQuery(this)
                    ...
                    .append(
                      "<span class='vc_list_edit_button vc_list_edit_action' style='display:inline;'><span style='display:inline;' onclick='toEditor(this,event)'>" +
                        editname +
                        "</span><span style='display:inline;' onclick='parent.toeditlistmore(this,event,\"vc_list_image_element\")' title='修改样式，格式'>设置</span>"
                    );
                  if (
                    jQuery(this).find(".post-title").length > 0 &&
                    jQuery(this).find(".post-title .vc_list_edit_action")
                      .length == 0
                  ) {
                    var actionstr =
                      '<span class="fa fa-pencil vc_list_edit_action"  style="margin-left:10px;display:inline;" onclick="toEditor(this,event)" title="编辑"></span><span class="fa fa-cog vc_list_edit_action" style="margin-left:10px;display:inline;" onclick="parent.toeditlistmore(this,event,\'vc_list_title_element\')" title="修改样式，格式"></span>';
                    if (jQuery(this).find(".post-title >a").length > 0) {
                      ...
                      jQuery(this)
                        .find(".post-title >span:first")
                        .append(actionstr);
                    }
                    if (
                      jQuery(this).find(".post-title i.glyphicon").length > 0
                    ) {
                      jQuery(this)
                        .find(".post-title i.glyphicon")
                        .append(
                          '<span class="fa fa-cog vc_list_edit_action" style="margin-left:10px;" onclick="parent.toeditlistmore(this,event,\'vc_list_icon_element\')" title="修改样式，格式"></span>'
                        );
                    }
                  }
                  ...
                  if (jQuery(this).find(".post_excerpt").length > 0) {
                    var actionstr =
                      '<span class="fa fa-pencil vc_list_edit_action"  style="margin-left:10px;" onclick="toEditor(this,event)" title="编辑内容"></span><span class="fa fa-cog vc_list_edit_action" style="margin-left:10px;" onclick="parent.toeditlistmore(this,event,\'vc_text_element\')" title="修改内容样式，格式"></span>';
                    if (
                      jQuery(this).find(".post_excerpt >p").length > 0 &&
                      jQuery(this).find(".post_excerpt .vc_list_edit_action")
                        .length == 0
                    ) {
                  ...
                  if (
                    jQuery(this).find(".subtitle").length > 0 &&
                    jQuery(this).find(".subtitle .vc_list_edit_action")
                      .length == 0
                  ) {
                    var actionstr =
                  ...
                  if (
                    ...
                    var actionstr =
                      '<span class="fa fa-pencil vc_list_edit_action"  style="margin-left:10px;display:inline;z-index:2;position:relative;" onclick="parent.bitSettingsEdit(' +
                      current_pid +
                      ',\'设置商品\', \'product\');" title="编辑"></span><span class="fa fa-cog vc_list_edit_action" style="margin-left:10px;display:inline;z-index:2;position:relative;" onclick="parent.toeditlistmore(this,event,\'vc_list_price_element\')" title="修改样式，格式"></span>';
                    jQuery(this).find(".price_warp").append(actionstr);
                  }
                  if (
                    jQuery(this).find(".post-comment").length > 0 &&
                    jQuery(this).find(".post-comment .vc_list_edit_action")
                      .length == 0
                  ) {
                    jQuery(this)
                      .find(".post-comment")
                      .append(
                        '<span class="fa fa-pencil vc_list_edit_action"  style="margin-left:10px;display:inline;" onclick="toEditor(this,event)" title="编辑"></span><span class="fa fa-cog vc_list_edit_action" style="margin-left:10px;" onclick="parent.toeditlistmore(this,event,\'vc_list_comment_element\')" title="修改样式，格式"></span>'
                      );
                  }
                  if (
                    jQuery(this).find(".vc_read_more").length > 0 &&
                    jQuery(this).find(".vc_read_more .vc_list_edit_action")
                      .length == 0
                  ) {
                    jQuery(this)
                      .find(".vc_read_more")
                      .append(
                        '<span class="fa fa-cog vc_list_edit_action" style="margin-left:10px;" onclick="parent.toeditlistmore(this,event,\'vc_list_readmore_element\')" title="修改样式，格式"></span>'
                      );
                  }
                }
              }
              ...
              .mouseenter(function () {
                if (p.find(".mypages .vc_list_edit_action").length == 0) {
                  p.find(".mypages").append(
                    '<span class="fa fa-cog vc_list_edit_action" style="margin-left:10px;" onclick="parent.toeditlistmore(this,event,\'vc_list_pagenav_element\')" title="修改样式，格式"></span>'
                  );
                }
              })
              .mouseleave(function () {
      ...
      $container
        .find(".categories_filter a:not(.link)")
        .data("isotope", $thumbs)
        .click(function (e) {
          e.preventDefault();
...
function vc_isotope_init_load(obj) {
  if (obj.find(".post-thumb img,.item_img img").length == 0) {
    obj.isotope({
      filter: "*",
      itemSelector: ".isotope-item",
      layoutMode: obj.attr("data-layout-mode")
        ? obj.attr("data-layout-mode")
        : "fitRows",
    });
...
function bitResizeImageTextInit() {
  jQuery(".bitImageControlDiv .bit-tp-caption.wf-mobile-hidden").each(
    function () {
        ...
        if (tmp.indexOf("|^^|") > -1) {
          ...
          if (tmparr.length == 2) {
            ...
            setTimeout(function () {
              ...
              top
                .jQuery(".boxy-wrapper:visible .copytitle")
                .html("点击确认，将复制该组件到当前页面");
            }, 300);
          }
        }
      }
...
/* vc_transition_bootstrap_js: (https://5b6d6cca63736.t73.qifeiye.com/qfy-content/plugins/qfy_editor/assets/lib/vc_carousel/js/transition.js) */
+(function ($) {
  "use strict";
...
/* vc_carousel_js: (https://5b6d6cca63736.t73.qifeiye.com/qfy-content/plugins/qfy_editor/assets/lib/vc_carousel/js/vc_carousel.js) */
/* ========================================================================
...
(function ($) {
  ...
  var Carousel = function (element, options) {
    if (
      $(window).width() < 768 &&
      $(element).hasClass("vc-carousel vc-slide")
    ) {
      options.interval = 0;
    }
  ...
  Carousel.prototype.getActiveIndex = function () {
    ...
    if (!this.$active.length)
      this.$active = this.$element.find(".vc-item:first").addClass("vc-active");
  ...
  Carousel.prototype.pause = function (e) {
    ...
    if (
      this.$element &&
      this.$element.find(".vc-next, .vc-prev").length &&
  ...
  Carousel.prototype.slide = function (type, next) {
    ...
    if (type == "prev" && $next.index() == -1 && this.options.viewnum > 0) {
      $next = this.$element.find(
        '.vc-item:eq("' + (this.items_count - this.options.viewnum * 1) + '")'
      );
    }
    ...
    if (
      $(window).width() < 768 &&
      this.$element.hasClass("vc-carousel vc-slide")
    ) {
      return;
    }
      ...
      this.$element.one("slid", function () {
        ...
        that.options.partial &&
          ...
          (index + 1 < that.items_count
            ? $nextIndicator.last().next().addClass("vc-partial")
            : $nextIndicator.first().prev().addClass("vc-partial"));
  ...
  Carousel.prototype.resizeAction = function () {
    ...
    if (this.options.mode === "horizontal") {
      this.el_effect_size =
        this.$element.width() * (this.options.partial ? this.partial_part : 1);
    ...
    if (this.options.mode === "vertical") {
      ...
      new_slideline_height =
        ...
        (this.options.partial ? 1 + 1 - this.partial_part : 1);
  ...
  Carousel.prototype._build = function () {
    ...
    this.current_index = 0;
    // TODO: default start position by options
    ...
    if (this.options.perView > 1)
      this.$element.addClass(
        "vc-per-view-more vc-per-view-" + this.options.perView
      );

    if (mode === "horizontal") {
      this.pos_units = "%";
      this._step = 100.0 / this.items_count / this.options.perView;
    ...
    // Set indicator
    if (this.$indicators.length) {
      var $active_indecators = that.$indicators
        .children()
    ...
    if (el.addEventListener) {
      ...
      el.addEventListener(
        ...
        function (e) {
          ...
          _pos_before_touch = that.$slideline_inner.position()[
            that.animation_position
          ];
        }.bind(this),
        false
      );
      el.addEventListener(
        ...
        function (e) {
          ...
          e.preventDefault();
          that.slideline_inner.style[that.animation_position] =
      ...
      el.addEventListener(
        ...
        function (e) {
          ...
          if (_moved) {
            ...
            if (
              (velocity.x > that.swipe_velocity && part < 0) ||
              part <= -0.7
            ) {
...
/* waypoints: (https://5b6d6cca63736.t73.qifeiye.com/qfy-content/plugins/qfy_editor/assets/lib/jquery-waypoints/waypoints.min.js) */
...
/* jquery-blockui: (https://5b6d6cca63736.t73.qifeiye.com/qfy-content/plugins/bitcommerce/assets/js/jquery-blockui/jquery.blockUI.min.js) */
/*!
...
(function () {
  ...
  function e(e) {
    function a(i, a) {
      ...
      var k =
        s &&
        (!e.support.boxModel || e("object,embed", m ? null : i).length > 0);
      if (r || k) {
        m &&
          a.allowBodyStretch &&
          e.support.boxModel &&
    ...
    function h(t) {
      ...
      return a.parents("div." + s.blockMsgClass).length > 0
        ? !0
...
/* dt-plugins: (https://5b6d6cca63736.t73.qifeiye.com/qfy-content/themes/qfy-01/js/plugins.js) */
/*jquery-parallax*/
/*scroll 用到*/
...
(function ($, window, undefined) {
  ...
  $.DLMenu.prototype = {
    ...
    _config: function () {
      ...
      /* ! !changed */
      this.openCap =
        '<span class="wf-phone-visible">&nbsp;</span><span class="wf-phone-hidden phone-text">' +
        this.$el.find(".menu-open").html() +
        "</span><span class='mobile_icon glyphicon glyphicon-icon-angle-down' ></span>";
      this.closeCap =
        '<span class="wf-phone-visible">&nbsp;</span><span class="wf-phone-hidden  phone-text">' +
        this.$el.find(".menu-close").html() +
        "</span><span class='mobile_icon  glyphicon glyphicon-icon-angle-down' ></span>";
      /* !changed: end */

      if (
        $("body").hasClass("mobilefloatmenu") &&
        this.$trigger.closest(".floatmenu,.fullfloatmenu").length > 0 &&
        ...
        if (self.open) {
          ...
          if (self.$trigger.hasClass("leftbtnmenu")) {
            if (jQuery("body >.dl-menu-film").length == 0) {
              jQuery("body").prepend(
                "<div class='dl-menu-film wf-mobile-visible'></div>"
              );
            }
            jQuery("body >.dl-menu-film")
              .off("click")
        ...
        if ($submenu.length > 0) {
          ...
          if (
            $item
              .closest("#dl-menu")
              .find(">#mobile-menu")
              .hasClass("firstopensub") ||
            jQuery("#dl-menu >#mobile-menu").hasClass("firstopensub")
          ) {
            var textw =
              $item.find(">a>span").width() * 1 +
              $item.find(">a>span").offset().left * 1;
            isclick = xx < textw;
          }
          ...
          if (isclick) {
            if (
              ...
              $item.find("a").attr("href").indexOf("#") > -1
            ) {
              //self._closeMenu();
            }
          } else {
            ...
            if ($(this).closest(".dl-menuwrapper").hasClass("leftbtnmenu")) {
              ...
              var $flyin = $submenu
                  ...
                  .addClass(self.options.animationClasses.animIn),
                onAnimationEndFn = function () {
                  self.$menu
                    .off(self.animEndEventName)
                    .removeClass(self.options.animationClasses.animOut)
                    .addClass("dl-subview");
                  $item
      ...
      this.$back.on("click.dlmenu", function (event) {
        ...
        var $this = $(this),
          ...
          $flyin = $submenu
            .clone()
            .insertAfter(self.$menu)
            .addClass(self.options.animationClasses.animOut);

        var onAnimationEndFn = function () {
          self.$menu
            .off(self.animEndEventName)
            .removeClass(self.options.animationClasses.animIn);
          $flyin.remove();
        };
      ...
      if (
        ...
        if (!$(".floatwarpper").hasClass("leftbtnmenu")) {
          $(".mobilefloatmenu.dl-menu-open #page")
            .css("transform", "translate3d(-" + w + "px, 0px, 0px)")
            .css("-webkit-transform", "translate3d(-" + w + "px,0,0)");
...
/* Sandbox: end */
/* dt-main-op-jquery: (https://5b6d6cca63736.t73.qifeiye.com/FeiEditor/bitSite/js/opentip-jquery.min.js) */
// Opentip v2.4.6
...
/* dt-language: (https://5b6d6cca63736.t73.qifeiye.com/qfy-content/themes/qfy-01/js/language.js) */
jQuery(function () {
...
/* dt-main: (https://5b6d6cca63736.t73.qifeiye.com/qfy-content/themes/qfy-01/js/main.js) */
//悬浮效果
(function ($) {
  $.fn.floatAd = function (l) {
    ...
    if (l.close == "1") {
      if (l.closeHTML == "") {
        o +=
          "<div id='qfy_close_f_ad' class='" +
          l.id_class +
          "' style='position:absolute;width:30px;height:16px;top:-18px;right:0px;cursor:pointer;float:right;font-size:14px'>关闭</div></div>";
      } else {
        o +=
          "<div id='qfy_close_f_ad' class='" +
          l.id_class +
...
function get_browser_name() {
  ...
  return -1 < e.indexOf("Opera") || -1 < e.indexOf("OPR/")
    ? "Opera"
    : -1 < e.indexOf("Edge")
    ? "Edge"
    : -1 < e.indexOf("Chrome")
    ...
    : -1 < e.indexOf("Firefox")
    ? "Firefox"
    : -1 < e.indexOf("MSIE") || -1 < e.indexOf("Trident/7")
    ? "IE"
    : "Other";
}
...
function searchForm(obj) {
  if (typeof obj == "undefined") {
    obj = jQuery(
      ".site_tooler .searchform .submit,.search_contain .searchform .submit"
    );
  }
...
function mobile_menu_fix() {
  ...
  var top_scrTop = 0,
    ...
    top_isMoved = false;
  var top_threshold =
    jQuery("#dl-menu").offset().top + jQuery("#dl-menu").height();
...
function mobile_menu_fix_2() {
  ...
  if (
    jQuery(".dl-menu-fixed-blank").length == 0 &&
    jQuery("#page").css("position") != "absolute"
  ) {
    jQuery(".dl-menu-fixedheader").after(
      "<div class='dl-menu-fixed-blank' style='display:none;height:" +
        top_threshold +
        "px;'></div>"
    );
  }
...
function _image_popup_flexslider(startAt) {
  jQuery(".image_popup .qfe_flexslider").flexslider({
    ...
    startAt: startAt,
    start: function () {
      var localvideo = jQuery(
        ".image_popup .flex-active-slide video.localvideo"
      );
      if (localvideo.length > 0) {
        if (localvideo.get(0).currentTime == 0) {
          jQuery(".image_popup .flex-active-slide video.localvideo")
            .get(0)
            .play();
        }
      }
      var videoiframe = jQuery(
        ".image_popup .flex-active-slide iframe.media-cloud-iframe"
      );
  ...
  jQuery("a.bitIcon").live({
    mouseenter: function () {
      ...
      if (borderhovercolor) {
        jQuery(this)
          .find("b")
          .css("border", "1px solid " + borderhovercolor);
        jQuery(this).find("b").css("transition", str);
      }
    },
    mouseleave: function () {
  ...
  jQuery("a.qfy_popup").live({
    click: function (e) {
      ...
      if (popupmodel == "0") {
        ...
        var isvideo = jQuery(this)
          .closest(".qfy_item_post")
          .find("video.qfyvideo").length;
        var isyunvideo = jQuery(this)
          .closest(".qfy_item_post")
          .find(".video_play >iframe").length;
        var video_html = "";
        var videoclass = "";
        if (isvideo) {
          videoclass = "video";
          var video_html = jQuery(this)
            .closest(".qfy_item_post")
            .find("video.qfyvideo")
            .prop("outerHTML");
          video_html = jQuery(video_html)
            .attr("controls", "controls")
            .attr("class", "localvideo simple")
            .attr("style", "width:100%;height:100%;background:#000;")
            .prop("outerHTML");
        } else if (isyunvideo) {
          videoclass = "video";
          var video_html = jQuery(this)
            .closest(".qfy_item_post")
            .find(".video_play >iframe")
            .prop("outerHTML");
          ...
          video_html = jQuery(video_html)
            .attr("data-height", videoheight)
            .attr("data-autoplay", "true")
            .attr("src", jQuery(video_html).attr("data-src"))
            .prop("outerHTML");
        }
        if (default_img || video_html) {
          ...
          if (popupstyle == "0") {
            message =
              '<div class="pop_image pop_image1 ' +
              videoclass +
              '" style="width:' +
              width +
              "px;word-wrap: break-word;height:" +
              height +
              ...
              title +
              '</div><div class="content" style="color:#ccc;font-size:14px;">' +
              desc +
              "</div></div></div>";
          } else if (popupstyle == "1") {
            message =
              '<div class="pop_image pop_image2 ' +
              videoclass +
              '" style="width:' +
              width +
              "px;word-wrap: break-word;height:" +
              height +
              'px;"><div style="background-image:url(' +
              default_img +
              ...
              title +
              '</div><div class="subhead"  style="color:#999;font-size:14px;padding-bottom:10px;">' +
              subtitle +
              '</div><div class="content overflowy" style="color:#666;font-size:14px;overflow-y: auto;;">' +
              desc +
              "</div></div> </div>";
          } else if (popupstyle == "2") {
            message =
              '<div class="pop_image pop_image3 ' +
              videoclass +
              '" style="width:' +
              width +
              "px;word-wrap: break-word;height:" +
          ...
          allmessage =
            '<div class="image_popup" style="position:relative;">' +
            message +
            '<div class="block-close" style="position: absolute;top: 2px;right: 9px;color: rgb(204, 204, 204);cursor: pointer;">✕</div></div>';
        }
      } else {
        var p = jQuery(this).closest(".qfy-element");
        ...
        p.find(".qfy_item_post:visible").each(function (i) {
          ...
          if (default_img || video_html) {
            if (popupstyle == "0") {
              message +=
                '<li><div class="pop_image pop_image1 ' +
                videoclass +
                '" style="position:relative;word-wrap: break-word;width:' +
                width +
                "px;height:" +
                height +
                "px;background-image:url(" +
              ...
              message +=
                '<li><div class="pop_image pop_image2 ' +
                videoclass +
                '" style="position:relative;word-wrap: break-word;width:' +
                width +
                "px;height:" +
              ...
              message +=
                '<li><div class="pop_image pop_image3 ' +
                videoclass +
                '" style="position:relative;word-wrap: break-word;width:' +
                width +
                "px;height:" +
        ...
        allmessage =
          ...
          message +
          '</ul> </div><div class="block-close" style="position: absolute;top: 2px;right: 9px;color: rgb(204, 204, 204);cursor: pointer;">✕</div></div>';
      }
      if (allmessage) {
        jQuery.blockUI({
        ...
        if (jQuery(".pop_image2 .content.overflowy").length > 0) {
          ...
          var head =
            jQuery(".pop_image2 .head").height() +
            jQuery(".pop_image2 .subhead").height();
          ...
          var head =
            jQuery(".pop_image3 .head").height() +
            jQuery(".pop_image3 .subhead").height();
      ...
      top
        ...
        .append(
          '<div class="qfy_gallerys" style="position:fixed;top:0;left:0;width:100%;height:0;z-index:20000;"><iframe src="/FeiEditor/bitSite/gallerys?bgcolor=' +
            encodeURIComponent(dtGlobals.gallery_bgcolor) +
            "&tfamily=" +
            encodeURIComponent(dtGlobals.gallery_tfamily) +
            "&dfamily=" +
            encodeURIComponent(dtGlobals.gallery_dfamily) +
            "&blankclose=" +
            encodeURIComponent(dtGlobals.gallery_blankclose) +
            "&arrowstyle=" +
            encodeURIComponent(dtGlobals.gallery_arrowstyle) +
            "&showthumbs=" +
            dtGlobals.gallery_showthumbs +
            "&style=" +
            dtGlobals.gallery_style +
            "&autoplay=" +
            dtGlobals.gallery_autoplay +
            "&playspeed=" +
            dtGlobals.gallery_playspeed +
            "&imagesize=" +
            dtGlobals.gallery_imagesize +
            "&imageheight=" +
            dtGlobals.gallery_imageheight +
            "&stopbutton=" +
            dtGlobals.gallery_stopbutton +
            "&thumbsposition=" +
            dtGlobals.gallery_thumbsposition +
            "&tsize=" +
            dtGlobals.gallery_tsize +
            "&tcolor=" +
            encodeURIComponent(dtGlobals.gallery_tcolor) +
            "&dsize=" +
            dtGlobals.gallery_dsize +
            "&dcolor=" +
            encodeURIComponent(dtGlobals.gallery_dcolor) +
            "&default_img=" +
            default_img +
            "&thumbPath=" +
            thumbPath +
            "&time=" +
            Math.random() +
            '" width="100%" height="100%" border=0 style="border:0;" /></div>'
        );
    ...
    jQuery("a").each(function () {
      ...
      if (href && href.indexOf("/api/video-server/play.php") > -1) {
        ...
        if (typeof jQuery.blockUI == "undefined") {
          jQuery.getScript(
            "/qfy-content/plugins/bitcommerce/assets/js/jquery-blockui/jquery.blockUI.min.js"
          );
        }
            ...
            .bind("click", function (e) {
              ...
              if (bodywidth > width) {
                top.jQuery.blockUI({
                  ...
                  message:
                    "<iframe allowfullscreen class='videoframe' style='width:100%;height:100%;display:block;border:0;overflow:hidden;' data-height='" +
                    height +
                    "' data-controlBarVisibility='hover' data-autoplay='true' src='" +
                    url +
                    "' ></iframe><div class='block-close' style='position:absolute;top:-26px;right:-3px;color:#fff;'>✕</div><div class='block-move ' title='按住拖动位置' style='position:absolute;top: 0;left: 0;color:#fff;cursor:move;background: transparent;width: 100%;height: 80px;'></div>",
                });
              } else {
                ...
                top.jQuery.blockUI({
                  ...
                  message:
                    ...
                    "' data-controlBarVisibility='hover' data-autoplay='true' src='" +
                    url +
                    "' ></iframe><div class='block-close' style='position:absolute;top:-26px;right:7px;color:#fff;'>✕</div>",
                });
              }
              top
                .jQuery(".block-close")
              ...
              if (typeof top.jQuery.fn.draggable == "undefined") {
                top.jQuery
                  .getScript("/qfy-includes/js/jquery/ui.all.min.js")
                  .done(function () {
        ...
        href &&
        href.indexOf("iframe.php?video_mp4_local=") > -1 &&
        href.indexOf("size=") > -1 &&
        href.indexOf("&auto=") > -1
      ) {
        ...
        var newhref =
          href +
          "&video_volume=50&video_fullscreen=" +
          full +
          "&video_auto=" +
          auto +
          "&ispopup=1&video_theme=maccaco&video_bgcolor=%23000&KeepThis=true&TB_iframe=true&height=" +
          height +
          "&width=" +
          width;
        ...
        jQuery(this)
          ...
          .bind("click", function (e) {
            setTimeout(function () {
              jQuery("#TB_overlay:visible")
                .css("background-color", color)
                .css("opacity", opacity);
              jQuery("#TB_window:visible iframe").css(
                "background-color",
                color
              );
              if (full) {
...
function thebackground(qfy_bg_images, time) {
  ...
  for (i = 0; i < tmp_qfy_bg_images.length; i++) {
    ...
    if (i == 0) {
      str +=
        '<div style="position: absolute;opacity: 1;height:100%;width:100%;background:url(' +
        img +
        ')"  class="show"></div>';
    } else {
      str +=
        '<div style="position: absolute;opacity: 0;height:100%;width:100%;background:url(' +
        img +
        ')"  ></div>';
    }
  }
  ...
  jQuery("body .qfy_body_background > div")
    .css("background-color", bodyColor)
  ...
  setInterval(function () {
    var current = jQuery("div.qfy_body_background div.show")
      ? jQuery("div.qfy_body_background div.show")
      : jQuery("div.qfy_body_background div:first");
    if (current.length == 0)
      current = jQuery("div.qfy_body_background div:first");
...
function _vc_3d_photo() {
  jQuery(".qfy-360viewer:not(.loaded)").each(function () {
    ...
    if (jQuery("body").width() > 992) {
      ...
      var height = jQuery(this).attr("data-mheight")
        ? jQuery(this).attr("data-mheight")
        : "300px";
    }
    ...
    var auto = jQuery(this).attr("data-auto")
      ? jQuery(this).attr("data-auto")
      : "false";
    var autospeed = jQuery(this).attr("data-src")
      ? jQuery(this).attr("data-src")
      : "/FeiEditor/bitSite/3d/360-viewer/sun.jpg";
    ...
    var auto = jQuery(this).attr("data-auto")
      ? jQuery(this).attr("data-auto")
      : false;
    var autospeed = jQuery(this).attr("data-autospeed")
      ? jQuery(this).attr("data-autospeed")
      : "2rpm";
    ...
    PSV = new PhotoSphereViewer({
      ...
      // HTML loader
      loading_html:
        "<img class='loading' style='width:80px;position: absolute;left:50%;top:50%;transform: translate(-50%,-50%)' src='/FeiEditor/bitSite/images/new-loading.gif'/>",
        ...
        jQuery(this)
          ...
          .each(function (index) {
            ...
            if (curr.find(".line").length > 0) {
              var line =
                "<h5 class='qfydownline' style='position:relative;z-index:5;margin:0;padding:0;opacity:1;'>" +
                curr.find(".line").clone().prop("outerHTML") +
                "</h5>";
...
jQuery(document).ready(function ($) {
  ...
  if (
    $(".one-page-row").length &&
    $(".one-page-row div[data-anchor^='#']").length
  ) {
    if (urlHash != "#undefined") {
      $("html, body").animate(
        {
          scrollTop:
            $(".one-page-row div[data-anchor='" + urlHash + "']").offset().top -
            floatMenuH +
            1,
        },
        600,
    ...
    if (urlHash.indexOf("=") < 0 && $(urlHash).length > 0) {
      ...
      setTimeout(function () {
        $("html, body").animate(
          ...
          600,
          function () {
            jQuery("#parallax-nav a[href='" + urlHash + "']")
              .closest("li")
              .addClass("active");
            $("body").removeClass("is-scroll");
            parallax_scroll_fun();
  ...
  if (!is_edit_model) {
    if (
      $(".bitMainTopSider .vc-no-content-helper").length == 0 &&
      $(".bitMainTopSider").length > 0 &&
  ...
  $(window).on("resize", function () {
    ...
    if (jQuery("#header.logo-left-right #navigation ul.ab-center").length > 0) {
      ...
      jQuery("#header #navigation #main-nav")
  ...
  $("#main-nav .menu-item a,.dl-menu li a")
    .not(".dl-menu li.dl-back a[href^='#']")
    .each(function () {
      var $_this = $(this),
        selector = $_this.attr("href");
      ...
      if (
        ...
        if (
          ...
          $(this).on("click", function (e) {
            ...
            //手机下菜单是#，子菜单无法点击
            var mobilemenu = $_this.closest("#dl-menu").find("#mobile-menu")
              .length;
            ...
            $_this
              .closest("#dl-menu")
              .find(".wf-phone-hidden.phone-text")
              .click();
            var base_speed = 600,
              speed = base_speed;
                ...
                $("html, body").animate(
                  {
                    scrollTop:
                      $(
                        ".one-page-row div[data-anchor='" + selector + "']"
                      ).offset().top -
                      floatMenuH +
                      1,
                  },
  ...
  $(
    ".logo-box a[href^='#'], #branding a[href^='#'], #branding-bottom a[href^='#']"
  ).on("click", function (e) {
    $("body").addClass("is-scroll");
    if ($("#phantom").css("display") == "block") {
      var floatMenuH = $("#phantom").height();
    ...
    if (selector == "#") {
      ...
      if (
        ...
        $("html, body").animate(
          {
            scrollTop:
              $(".one-page-row div[data-anchor='" + selector + "']").offset()
                .top -
              floatMenuH +
              1,
          },
  ...
  jQuery(".mainmenu >.menu-item > a").each(function () {
    ...
    if (href.indexOf("#") > -1 && href != "#") {
      ...
      if (
        ...
        href_id.indexOf("=") < 0 &&
        href_id.indexOf("/") < 0 &&
        jQuery("section#" + href_id).length > 0
      ) {
        ...
        jQuery("#header").waypoint({
          handler: function (direction) {
            ...
            try {
              ...
              console.error(
                "history.pushState failed, maybe HTML5 is not supported?"
              );
            }
            _menu_link_event(hash);
          },
      ...
      .waypoint({
        handler: function (direction) {
          if (direction === "down") {
            ...
            if (jQuery("#parallax-nav").length > 0) {
              jQuery("#parallax-nav li").removeClass("active");
              jQuery("#parallax-nav [href='#" + curr_hash + "']")
                .parent()
                .addClass("active");
            }
...
function floatmenu_create() {
  ...
  if (smartMenu && $("#header").length > 0) {
    ...
    try {
      if (self != top && !top.jQuery("body").hasClass("caterole")) {
        ...
        controlDiv =
          ...
          pcontroldiv +
          '<div class="controls-cc"><a class="control-btn vc-element-name"><span class="vc-btn-content vo-btn-nomove">浮动菜单和LOGO</span></a><a class="control-btn control-btn-edit " onclick="top.qfFloatMenuSetting()" title="设置 浮动菜单样式"><span class="vc-btn-content"><span class="icon"></span></span></a></div></div>';
      }
    } catch (e) {}
    ...
    if (dtGlobals.logoURL && dtGlobals.logoEnabled) {
      ...
      if (dtGlobals.logoURL) {
        ...
        $phantom
          .find(".logo-box")
          .html(
            '<div style="height:48px;vertical-align: ' +
              valign +
              ';display: table-cell;" >' +
              img_str +
              "</div>"
    ...
    if (f_maxwidth > 0) {
      $("#phantom .ph-wrap .ph-wrap-content").css(
        "max-width",
        f_maxwidth + "px"
      );
    }
    ...
    if (
      jQuery("#header.bit-logo-menu").length > 0 &&
      !$("#phantom").hasClass("bit-logo-menu")
    ) {
      ...
      if (tempScrTop > threshold && isMoved === false) {
        if (!dtGlobals.isHovering) {
          ...
          if ($("#phantom").hasClass("bit-logo-menu")) {
            if (dtGlobals.logoURL && dtGlobals.logoEnabled) {
              $header
                .find("#branding .logo img:first")
                .attr("src", dtGlobals.logoURL);
            }
          }

          if (jQuery("#header.newrightmenu,#header.newleftmenu").length > 0) {
            if (
              jQuery("#dl-menu:visible").length == 0 &&
              jQuery("body").height() - threshold - tempScrTop >
            ...
            $header
              .removeClass($header.data("bit-menu"))
              .addClass($header.data("bit-float-menu"))
              .removeClass("bit-menu-default")
              .addClass("bit-menu-float");
          }
        ...
        if (jQuery("#header.newrightmenu,#header.newleftmenu").length > 0) {
          ...
          $header
            .removeClass($header.data("bit-float-menu"))
            .addClass($header.data("bit-menu"))
            .addClass("bit-menu-default")
            .removeClass("bit-menu-float");
        }
...
function _menu_link_event(hash) {
  ...
  if (
    ...
    $(
      ".widget_nav_menu ul.menu,.qfy-listmenuvertical ul.menu,.widget_nav_menuhorizontal ul.menu"
    ).each(function () {
      ...
      $(this)
        ...
        .each(function () {
          ...
          if (href.substr(start) == hash && ismenuhash == false) {
            ...
            ul.find(".current-menu-item").removeClass(
...
function mainmenu_event() {
  ...
  if ($("#mobile-menu").hasClass("dropTopStyle")) {
    $("#mobile-menu")
      .removeClass("glyphicon glyphicon-icon-align-justify")
      .append(
    ...
    $("body").prepend(
      "<div id='dl-menu' class='dl-menuwrapper wf-mobile-visible dropTopStyle_containter' >" +
        menu_html +
        "</div>"
    );
    menu_html = null;
    ...
    $("#dl-menu:not(.dl-qfymobile-menu)").remove();
    $("#header").after(
      "<div id='dl-menu' class='dl-menuwrapper wf-mobile-visible dropCenterStyle_containter' >" +
        menu_html +
        "</div>"
    );
    menu_html = null;
    ...
    //default
    if ($("#mobile-menu").hasClass("positionFixed")) {
      $("#dl-menu:not(.dl-qfymobile-menu)").addClass(
        "mobiledefault_containter"
      );
      mobile_menu_fix();
    }
  }
  ...
  $(".underline-hover > li > a > span")
    .not(".underline-hover > li > a > span.mega-icon")
  ...
  $mobileNav
    ...
    .removeClass("sub-nav")
    .prepend(
      "<li class='menu-item dl-back'><a href='#'><span>" + backCap + "</a></li>"
    );

  $mobileNav
    .appendTo("#dl-menu:not(.dl-qfymobile-menu)")
    .wrap("<div class='dl-container' />");

  $("body").removeClass("mobilefloatmenu");
  $("body >.dl-menu-film,body >.dl-menu-fixedheader").remove();
  if (
    $("#mobile-menu").hasClass("floatmenu") ||
    $("#mobile-menu").hasClass("fullfloatmenu") ||
    $("#mobile-menu").hasClass("leftbtnmenu")
  ) {
    $("body").addClass("mobilefloatmenu");
    var menu_content = $("#dl-menu:not(.dl-qfymobile-menu) .dl-container").prop(
      "outerHTML"
    );
    $("#dl-menu:not(.dl-qfymobile-menu) .dl-container").remove();
    $("body").prepend(
      "<div  class='dl-menuwrapper  wf-mobile-visible floatmenu floatwarpper' >" +
        menu_content +
        "</div>"
    );
    var menu_html = $("#dl-menu:not(.dl-qfymobile-menu) #mobile-menu").prop(
      "outerHTML"
    );
    $("#dl-menu:not(.dl-qfymobile-menu) #mobile-menu").remove();
    $("body #page").prepend(
      "<div id='dl-menu' class='dl-menuwrapper wf-mobile-visible floatmenu' >" +
        menu_html +
        "</div>"
    );
    ...
    if ($("#mobile-menu").hasClass("fullfloatmenu")) {
      ...
      $(".dl-menuwrapper.floatmenu")
        .addClass("leftbtnmenu")
        .find(".dl-container")
        .prepend(jQuery(".menu_displaynone").html())
      ...
      if (
        $("body >.dl-menu-fixedheader").length == 0 &&
        $(".leftbtnmenu #mobile-menu.displaynone").length == 0
      ) {
        if ($(".yy_website_notice").length > 0) {
          $(".yy_website_notice").after(
            "<div class='dl-menu-fixedheader wf-mobile-visible'>" +
              jQuery(".menu_displaynone_header").html() +
              "</div>"
          );
        } else {
          $("body").prepend(
      ...
      if (top != self && jQuery("body").hasClass("compose-mode")) {
        jQuery("body")
          .find(
            ".qfyheadercontent [bitDataAction='site_widget_container'] .site_tooler"
          )
          .each(function () {
            parent.widgetHover(this, jQuery("body"));
          });
        jQuery("body")
          .find(".qfyheadercontent [bitDataAction='site_fix_container']")
          .each(function () {
      ...
      mobile_menu_fix_2();
      if (
        jQuery(window).scrollTop() > jQuery(".dl-menu-fixedheader").height()
      ) {
        jQuery(".dl-menu-fixedheader").css("position", "fixed");
        jQuery("body").addClass("fixedheadering");
      } else {
  ...
  if (!$("html").hasClass("old-ie"))
    $("#dl-menu:not(.dl-qfymobile-menu)").dlmenu();

  var timeouthidden = new Array();
  $(".qfy-sub-div.MenuAnimIn_js", $mainNav)
    .parent()
    .each(function (i) {
      var $this = jQuery(this);
  ...
  $(".sub-nav", $mainNav)
    ...
    .each(function () {
      ...
      var menuTimeoutShow, menuTimeoutHide;
      ...
      if ($this.hasClass("dt-mega-menu")) {
        $this.on("mouseenter tap", function (e) {
          ...
          if (
            $("#page").width() -
              ($this.children("ul").offset().left - $("#page").offset().left) -
        ...
        $this.on("mouseenter tap", function (e) {
          ...
          if (
            $this.find(".qfy-sub-div").length == 0 &&
            $this.closest(".qfyheaderul").length == 0
          ) {
            menuTimeoutShow = setTimeout(function () {
              if ($this.hasClass("dt-hovered")) {
                if ($this.closest("#main-nav").attr("data-sliderdown")) {
                  ...
                  $this.closest("#main-nav").hasClass("sub-sliderup")
                ) {
                  $this
                    .children("ul")
                    .stop()
...
function base64_encode(str) {
  ...
  if (r == 1) {
    c = str.charCodeAt(i++);
    out[j++] =
      base64EncodeChars[c >> 2] + base64EncodeChars[(c & 0x03) << 4] + "==";
  } else if (r == 2) {
    c = (str.charCodeAt(i++) << 8) | str.charCodeAt(i++);
    out[j++] =
      base64EncodeChars[c >> 10] +
...
function weiBoAndWeiXinToolTip() {
  ...
  objs.each(function () {
    ...
    obj.attr("title", "");
    var title =
      "<img src='/FeiEditor/public_api/getImageFromWebApi/weixin/" +
      name +
      "'  width='160'/><div>请扫二维码关注微信</div>";
    var data = {
      tipJoint: "bottom",
      style: "dark",
    };
  ...
  objs.each(function () {
    ...
    obj.attr("title", "");
    var title =
      "<img src='/FeiEditor/public_api/getImageFromWebApi/weibo/" +
      name +
      "' width='160' /><div>请扫二维码关注微博</div>";
    var data = {
      tipJoint: "bottom",
      style: "dark",
    };
...
function vc_gallery_relat() {
  jQuery(".qfe_gallery.rela_other .vc-carousel .qfy_image_vc_item img").each(
    function () {
      var img = jQuery(this);
        ...
        jQuery(".qfe_gallery.rela_other .slides").each(function () {
          ...
          obj.find("img").each(function () {
            ...
            if (!p.hasClass("clone") && src == tosrc) {
              ...
              p.parent().css(
                "-webkit-transform",
                "translate3d(-" + index * width + "px, 0px, 0px)"
              );
              p.parent().css(
                "transform",
                "translate3d(-" + index * width + "px, 0px, 0px)"
...
function qfbookformSubmit(obj) {
  if (!is_edit_model) {
    ...
    if (url.indexOf("?") > -1) {
      location.href =
        url +
        "&QFBOOKSearch-check-in-view=" +
        t1 +
        "&QFBOOKSearch-check-out-view=" +
        t2;
    } else {
      location.href =
        url +
...
function qfytemplate_hover() {
  jQuery(".qfy-template-content .qfy_template_lib a").hover(
    function () {
...
function template_add_points($this, points) {
  if (
    location.host == "www.qifeiye.com" ||
    location.host == "0000007.localhost.com"
  ) {
...
function searchqfylist(tag, paged, flag) {
  if (!is_edit_model) {
    ...
    if (
      jQuery(".qfytemplateslist .viewmoretemplate .loadingimage").length > 0
    ) {
      return;
    }
    ...
    jQuery(
      ".qfytemplateslist .viewmoretemplate .viewmoretemplate_inner"
    ).hide();
    jQuery(".qfytemplateslist .viewmoretemplate").append(
      "<div class='loadingimage' style='text-align:center;margin:50px auto;'><img style='vertical-align: middle;width:30px;' src='//f.goodq.top/FeiEditor/bitSite/images/preloader.gif' /><span style='color:#0088c2;margin-left:10px;'>正在自动加载更多模板...</span></div>"
    );
    ...
    jQuery.post(
      ...
      function (data) {
        ...
        if (data) {
          if (flag == "append") {
            jQuery(".qfytemplateslist .qfy-template-content-inner").append(
              data
            );
          ...
          jQuery(".qfytemplateslist  .img_inner")
            .unbind()
            .mouseenter(function () {
              var $this = this;
          ...
          jQuery(".qfytemplateslist .viewmoretemplate_inner")
            .unbind()
            .click(function () {
              var tag = "all-0";
              if (jQuery(".qfytemplateslist .itemli.active").attr("data-tag")) {
                tag = jQuery(".qfytemplateslist .itemli.active").attr(
                  "data-tag"
                );
              }
          ...
          jQuery(".qfy_template_lib .viewmoretemplate")
            .unbind()
            .waypoint({
              handler: function (direction) {
                if (
                  jQuery(
                    ".qfy_template_lib .viewmoretemplate .viewmoretemplate_inner"
                  ).length > 0
                ) {
                  jQuery(
                    ".qfy_template_lib .viewmoretemplate .viewmoretemplate_inner"
        ...
        handler: function () {
          if (!jQuery($this).hasClass("active") && isqfyscrolling == false) {
            ...
            if (jQuery("#parallax-nav").hasClass("color-weight-dark")) {
              var bordercolor = jQuery("#parallax-nav li.active a").attr(
                "data-color"
              );
              if (!bordercolor) {
                bordercolor = orgcolor;
              }
              jQuery("#parallax-nav li a")
                .css("border-color", bordercolor)
                .css("background-color", "transparent")
                .css("color", bordercolor);
              jQuery("#parallax-nav .active a")
                .css("border-color", bordercolor)
              ...
              jQuery("#parallax-nav li a")
                ...
                .css("background-color", bordercolor)
                .css("color", bordercolor);
              jQuery("#parallax-nav li.active a")
                .css("border-color", bordercolor)
                .css("background-color", "transparent")
                .css("color", bordercolor);
            }
  ...
  if (jQuery("#parallax-nav.mouseEvent").length > 0) {
    var qfyscrollFunc = function (e) {
      ...
      if ((e.wheelDelta && e.wheelDelta > 0) || (e.detail && e.detail < 0)) {
        //上
        var thisobj = jQuery("#parallax-nav.mouseEvent .active")
          .prev()
          .find("a");
        if (thisobj.length > 0) {
          qfyToscroll(thisobj);
...
function checkAdvertising() {
  ...
  if (jAdObj.length == 0) {
    var tmphtml =
      '<a class="wf-mobile-hidden qfy_advertising" target=_blank style="' +
      style +
...
function nav_pagemore(obj) {
  ...
  if (jQuery(obj).parent().hasClass("bitcommerce-pagination")) {
    ...
    var luClass =
      "[qfyuuid='" +
      id +
      "'].qfe_teaser_grid.qfe_content_element ul.qfe_thumbnails";
  ...
  p.find(
    ".qfe_teaser_grid.qfe_content_element .teaser_grid_container"
  ).addClass("noanimale");
  p.find(luClass + " li")
    .css("transform", "none")
    .css("top", "auto")
  ...
  if (typeof global_image_loading != "undefined") {
    jQuery(obj).after(
      '<div class="qfy_list_loading"  style="margin:0 auto;text-align:center;">' +
        global_image_loading +
        "</div>"
    );
  } else {
    jQuery(obj).after(
  ...
  jQuery.get(url, function (data) {
    ...
    if (p.hasClass("noanimale") || p.find(".noanimale").length > 0) {
      ...
      p.find(childClass + ">li:not(.mobile_list_inner)")
        .attr("style", style)
        .css("transform", "none")
        .css("top", "auto")
        .css("position", "relative");
    ...
    if (p.attr("data-open") == "1") changelistlinkfun(p);
    ...
    if (
      !p.hasClass("noanimale") &&
      p.find(".isotope-item").length > 0 &&
      p.find(".noanimale").length == 0
    ) {
...
function bindqfylist(obj, curr) {
  ...
  jQuery(
    ".qfy-element.qfe_teaser_grid.qfe_content_element,.qfy-element.qfyproductlist"
  )
    .css("outline", "10px solid #FF6600")
    .css("cursor", "cursor")
    .css("opacity", "0.6");
  jQuery(
    ".qfy-element.qfe_teaser_grid.qfe_content_element,.qfy-element.qfyproductlist"
  )
    .unbind("click.bindqfylist")
    .bind("click.bindqfylist", function (e) {
      var item = $(e.currentTarget);

      jQuery("body").removeClass("doing");
      var list = item.closest(
        ".qfy-element.qfe_teaser_grid.qfe_content_element,.qfy-element.qfyproductlist"
      );
      ...
      //能添加uuid，则添加uuid
      if (
        list.parent().attr("data-model-id") &&
        post_type != "page" &&
        (!val || val == 0 || val == "")
      ) {
        ...
        listparams.qfyuuid =
          "qfy_posts_grid_" + parent.vc.ShortcodesBuilder.randomString();
        listmodel.save(
          {
            params: listparams,
          },
      ...
      if (val && val != 0 && val != "" && post_type != "page") {
        ...
        if (c.closest(".vc-element").attr("data-model-id")) {
          ...
          jQuery.post(
            "/FeiEditor/siteEdit/updatePostlistOneparam",
            {
              wid: wid,
              bind_pageid: pageid,
        ...
        top.jAlert(
          "这个列表还没有设置自己的UUID，你可以在设置中添加该列表唯一的UUID"
        );
      }
    });
}
function nav_pagecate_confirm(obj) {
  ...
  if (
    jQuery(obj).closest(".dl-menuwrapper.dropCenterStyle_containter").length >
      0 &&
    !li.hasClass("has-children")
  ) {
    jQuery(obj)
      .closest(".dl-menuwrapper.dropCenterStyle_containter")
      .find("a.dropCenterStyle")
      .click();
  }
  ...
  if (c.attr("data-child") == "1") {
    ...
    if (li.hasClass("cat-parent") && li.closest(".list-content").length > 0)
  ...
  var p = jQuery(
    "[qfyuuid='" + id + "'].qfe_teaser_grid.qfe_content_element"
  ).parent();
  ...
  if (model_id && parent) {
    ...
    if (params.parse_url) var parse_url_old = params.parse_url;
    if (params.parse_search) var parse_search_old = params.parse_search;
    params.parse_url = "0";
    ...
    if (parse_url_old) params.parse_url = parse_url_old;
    if (parse_search_old) params.parse_search = parse_search_old;
    model.save({
      params: params,
    });
  }
...
function nav_customsearch(obj) {
  ...
  if (li.hasClass("active")) {
    ...
    if (
      ul.closest("ul.subul").attr("data-morecheck") == "0" ||
      li.attr("data-id") == "-1"
    ) {
      ul.find(">li").removeClass("active");
    }
  ...
  if (p.attr("data-ajax") == "1") {
    ...
    var image_src =
      "//f.goodq.top/qfy-content/plugins/qfy_form/admin/images/loading.gif";
    var w = "";
    if (touuid != "-1") {
    ...
    plist.html(
      '<div class="qfy_list_loading"  style="margin:50px auto;text-align:center;"><img  style="width:' +
        w +
        'px"  src="' +
        image_src +
        '"></div>'
...
function nav_pagecate(obj, flag) {
  ...
  jQuery.get(url, function (data) {
    ...
    if (nowlistobj.attr("data-open") == "1") changelistlinkfun(nowlistobj);
...
function qfy_notice_event() {
  if (
    jQuery(".qfy-element.qfy_notice .notice_warp").length > 0 ||
...
function gototab(obj) {
  ...
  if (p.find(".royalSlider_gallery_new").attr("transitiontype") == "none") {
    if (p.find(".royalSlider_gallery_new>.vc-element").length > 0) {
      p.find(".royalSlider_gallery_new>.vc-element")
        .removeClass("edittabshow")
        .addClass("edittabhide");
      p.find(".royalSlider_gallery_new>.vc-element:eq(" + index + ")")
        .removeClass("edittabhide")
        .addClass("edittabshow");
    } else {
      p.find(".royalSlider_gallery_new>section").hide();
      p.find(".royalSlider_gallery_new>section:eq(" + index + ")")
        .show()
        .css("height", "100%");
    }
  } else {
...
function qfy_btn_primry_notice(obj) {
  ...
  if (p.length == 1) {
    ...
    var allow_forceclose = p
      .find(".notice_content")
      .attr("data-allow1_forceclose");
  ...
  $this
    ...
    .click(function (event) {
      ...
      h.find(".list_hiddencontent").html(
        '<div class="qfy_list_loading"  style="margin:0 auto;padding:100px 0;text-align:center;"><img style="width:' +
          w +
          'px" src="' +
          image_src +
          '"></div>'
      ...
      jQuery.get(link, function (data) {
        ...
        if (slider == "1") {
          ...
          if (jQuery(data).find(".bitMainTopSider").length > 0) {
            htm_prev =
              "<div class='bmts' style='position:relative;width:100%'>" +
              jQuery(data).find(".bitMainTopSider").html() +
              "</div>";
          }
          if (jQuery(data).find(".bitMainBottomSider").length > 0) {
            htm_next =
              "<div class='bmbs'  style='position:relative;width:100%'>" +
              jQuery(data).find(".bitMainBottomSider").html() +
              "</div>";
          }
...
function qfy_template_preiview_fun(url, select_url) {
  if (
    ...
    jQuery(".qfytemplateslist.third").length > 0
  ) {
    location.href = url;
    return;
  }
  ...
  jQuery("body").append(
    '<div id=\'qfy_template_preivew\' class=\'pc-selected\'><div id=\'qfy_template_preivew_header\'><span style=\'float:left;\' > <span class=\'back\' style=\'position: relative;top:-6px;font-size:12px;\'><svg style=\'position: relative;top:2px;margin-right:3px;stroke: #222;stroke-width: 7px;width: 14px;overflow: visible;-webkit-transform: scaleX(-1);transform: scaleX(-1);\' width="8px" height="13px" viewBox="0 0 8 13" version="1.1"><g style=\'fill: #222;\' id="Visual-Design" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" opacity="1"><g id="9b" transform="translate(-344.000000, -357.000000)" fill="#222222"><g id="templates" transform="translate(-202.000000, 165.000000)"><path d="M544,195 L544,203 L543,203 L543,195 L543,194 L552,194 L552,195 L544,195 Z" id="Combined-Shape" transform="translate(547.500000, 198.500000) rotate(-225.000000) translate(-547.500000, -198.500000) "></path></g></g></g></svg>返回 </span> <svg class=\'pc\'  width="28" height="22" viewBox="0 0 28 22" xmlns="http://www.w3.org/2000/svg"><g fill="#000" fill-rule="evenodd"><path d="M11 18h1v4h-1z"></path><path d="M9 21h10v1H9z"></path><path d="M16 18h1v4h-1z"></path><path d="M1 3v13c0 1.11.891 2 1.996 2h22.008A2.004 2.004 0 0 0 27 16V3c0-1.11-.891-2-1.996-2H2.996A2.004 2.004 0 0 0 1 3zM0 3c0-1.657 1.35-3 2.996-3h22.008A2.994 2.994 0 0 1 28 3v13c0 1.657-1.35 3-2.996 3H2.996A2.994 2.994 0 0 1 0 16V3z"></path></g></svg><svg class=\'mobile\' width="12" height="22" viewBox="0 0 12 22" xmlns="http://www.w3.org/2000/svg"><g fill="#000" fill-rule="evenodd"><path d="M1 3.001V19C1 20.105 1.894 21 2.997 21h6.006A2 2 0 0 0 11 18.999V3A1.999 1.999 0 0 0 9.003 1H2.997A2 2 0 0 0 1 3.001zm-1 0A3 3 0 0 1 2.997 0h6.006A2.999 2.999 0 0 1 12 3.001V19A3 3 0 0 1 9.003 22H2.997A2.999 2.999 0 0 1 0 18.999V3z"></path><path d="M5 18h2v2H5z"></path></g></svg> </span>  <span  style=\'float:right;\'><a class=\'preivew\' target=\'_blank\' href=\'' +
      ...
      "'>访问演示网站</a><a href='" +
      select_url +
      '\'><button class=\'use\'>选用</button></a><svg class=\'back\'  style="width: 40px;height: 40px;fill:none;stroke:#000000;stroke-miterlimit:3;stroke-width:1px;position: relative;top: 15px;margin-right: 0;margin-left: 20px;"  viewBox="0 0 150 150" ><line  x1="8.15" y1="141.18" x2="141" y2="8.33"/><line  x1="8.15" y1="8.33" x2="141" y2="141.18"/></svg></span></div><div id=\'qfy_template_preivew_content\' ><div class=\'iframe-inner\'>' +
      header_str +
      "<iframe src='" +
      url +
      "'></iframe></div></div><div class='loading-iframe'></div></div>"
  );
...
jQuery(document).ready(function ($) {
  ...
  if (
    jQuery(
      ".qfy-listcatecontrols[data-child='1'],.qfy-listmenuvertical[data-child='1']"
    ).length > 0
  ) {
    jQuery(
      ".qfy-listcatecontrols[data-child='1'],.qfy-listmenuvertical[data-child='1']"
      ...
      if (cur.hasClass("cat-parent") && cur.closest(".list-content").length > 0)
        cur.find(">.children").show();
    });
  }
  if (jQuery(".qfy_template_lib .viewmoretemplate").length > 0) {
    jQuery(".qfy_template_lib .viewmoretemplate").waypoint({
      handler: function (direction) {
        if (
          jQuery(".qfy_template_lib .viewmoretemplate .viewmoretemplate_inner")
            .length > 0
        ) {
          jQuery(
            ".qfy_template_lib .viewmoretemplate .viewmoretemplate_inner"
  ...
  if (!is_edit_model) {
    jQuery(".qfe_teaser_grid.qfe_content_element[data-open='1']").each(
      function () {
        var $this = jQuery(this);
  ...
  //特殊处理一些网站
  if (
    jQuery(".re_second_user_class").length > 0 &&
    jQuery.trim(jQuery(".re_second_user_span").text()) == ""
  ) {
  ...
  if (jQuery(".qfytemplateslist").length > 0) {
    ...
    jQuery(".qfytemplateslist .mypages a")
      .removeAttr("href")
      .click(function () {
        var tag = "all-0";
        if (jQuery(".qfytemplateslist .itemli.active").attr("data-tag")) {
  ...
  setTimeout(function () {
    try {
      if (top != self && !jQuery("body").hasClass("compose-mode")) {
        if (
          top.jQuery("#pageUrl").length > 0 &&
          parent.jQuery("#vc-post-id").val() != dtGlobals.curr_id
        ) {
...
function qfy_popinfo_fun(htm, timetoclose) {
  ...
  if (htm) {
    var msg =
      '<div class="qfy_popinfo" ><div class="md-content">' +
      htm +
      "</div></div>";
...
function mobilecart_click(id) {
  if (
    jQuery("#product-" + id + " form .single_add_to_cart_button").length > 0
  ) {
    jQuery("#product-" + id + " form .single_add_to_cart_button").click();
  } else if (
    jQuery("#product-" + id + " .custom_btn_link .single_add_to_cart_button")
      .length > 0
  ) {
    jQuery(
      "#product-" + id + " .custom_btn_link .single_add_to_cart_button"
    ).click();
  }
}
function mobilecart() {
  ...
  jQuery(
    "#bottom-bar,#footer,#bitBanner,section.section,.right_nav_bar,#phantom"
  ).addClass("lowIndex");
  jQuery(".mobile_variation_warp")
    .closest("section")
    .removeClass("lowIndex")
    .addClass("topIndex");
  jQuery(".mobile_variation_warp")
    .closest(".bit_main_content")
    .addClass("topIndex");
  ...
  var isnotmove = false;
  if (
    jQuery("section.section.topIndex").length > 0 &&
    jQuery("section.section.topIndex").height() < height * 0.75
  ) {
    isnotmove = true;
  } else {
  ...
  if (!isnotmove) {
    jQuery("section.section.topIndex")
      .nextAll("section.section")
      .addClass("tmp_displaynone");
  ...
  jQuery.ajax({
    ...
    error: function (request) {
      ...
      if (element.parent().find(".qfyuser-warning").length == 0) {
        ...
        element.after(
          '<div class="qfyuser-warning"><i class="qfyuser-icon-caret-up"></i>提交失败</div>'
        );
        ...
        element
          .parent()
          .find(".qfyuser-warning")
          .html('<i class="qfyuser-icon-caret-up"></i>提交失败');
        element.parent().find(".qfyuser-warning").css({
          top: "0px",
          opacity: "1",
        });
    ...
    success: function (data) {
      ...
      if (data.status == "error") {
        ...
        if (element1.parent().find(".qfyuser-warning").length == 0) {
          ...
          element1.after(
            '<div class="qfyuser-warning"><i class="qfyuser-icon-caret-up"></i>' +
              data.msg +
              "</div>"
          );
          ...
          element1
            .parent()
            .find(".qfyuser-warning")
            .html('<i class="qfyuser-icon-caret-up"></i>' + data.msg);
          element1.parent().find(".qfyuser-warning").css({
            top: "0px",
            opacity: "1",
          });
    ...
    if (data != "success") {
      ...
      if (element.parent().find(".qfyuser-warning").length == 0) {
        ...
        element
          .parent()
          .find(".qfyuser-warning")
          .html('<i class="qfyuser-icon-caret-up"></i>' + data);
        element.parent().find(".qfyuser-warning").css({
          top: "0px",
          opacity: "1",
        });
...
function quick_search(obj) {
  ...
  var title = jQuery(obj).attr("data-title")
    ? jQuery(obj).attr("data-title")
    : "搜索";
  var placeholder = jQuery(obj).attr("data-placeholder")
    ? jQuery(obj).attr("data-placeholder")
    : "请输入关键词";
  var btn1 = jQuery(obj).attr("data-btn1")
    ? jQuery(obj).attr("data-btn1")
    : "确认";
  var btn2 = jQuery(obj).attr("data-btn2")
    ? jQuery(obj).attr("data-btn2")
    : "取消";
  ...
  if (jQuery(obj).attr("data-es") == "1") {
    ...
    message +=
      '<input type="hidden"  name="qfyuuid" value="' +
      jQuery(obj).attr("data-es-uuid") +
      '" />';
...
function login_button_click(id, link) {
  ...
  try {
    if (location.href.indexOf("qfy-login.php") > 0)
  ...
  location.href =
    ...
    "?connect=" +
    id +
    "&action=login&qfy_nocache=true&back=" +
    escape(back);
}
...
function play_qfy_video(obj) {
  ...
  if (ispop == "1") {
    ...
    top.jQuery.blockUI({
      css: block_css,
      message:
        "<iframe allowfullscreen style='width:100%;height:100%;display:block;border:0;overflow:hidden;' data-height='" +
        pop_height +
        "' data-cover='" +
        cover +
        "' data-controlbarvisibility='" +
        controlBarVisibility +
        "' data-volume='" +
        volume +
        "' data-autoplay='true' src='" +
        src +
        "' ></iframe><div class='block-close' style='position:absolute;top:-26px;right:-3px;color:#fff;'>✕</div><div class='block-move ' title='按住拖动位置' style='position:absolute;top: 0;left: 0;color:#fff;cursor:move;background: transparent;width: 100%;height: 80px;'></div>",
    });
    top
...
function play_local_video(obj) {
  ...
  top.jQuery.blockUI({
    css: block_css,
    message:
      "<iframe allowfullscreen style='width:100%;height:100%;display:block;border:0;overflow:hidden;' src='" +
      pop_href +
      "' ></iframe><div class='block-close' style='position:absolute;top:-26px;right:-3px;color:#fff;'>✕</div><div class='block-move ' title='按住拖动位置' style='position:absolute;top: 0;left: 0;color:#fff;cursor:move;background: transparent;width: 100%;height: 80px;'></div>",
  });
  top
...
function smsWarning(content, flag) {
  ...
  if (flag == "1") {
    parentDIv
      .find(".sms-warning")
      .html("<span style='color:green;'>" + content + "...</span>");
  } else {
...
function chang_city_init() {
  ...
  if (typeof wc_country_select_params === "undefined") return false;
  ...
  $("select.country_to_state, input.country_to_state")
    .change(function () {
      ...
      $("body").trigger("country_to_state_changing", [
        country,
        $(this).closest("div"),
      ]);
    })
    ...
    success: function (data) {
      ...
      if (data.status && data.key == "secodeinfo") {
        ...
        form
          .find("#secodeinfo")
          .html(
            "<div class='qfyuser-success' style='color:green;'>" +
              data.msg +
              "</div>"
          );
        ...
        if (bz_size)
          form
            .find("#secodeinfo .comment_content")
            .css("font-size", bz_size + "px");
        var bz_color = form.find("#secodeinfo").attr("data-bz_color");
        if (bz_color)
          form.find("#secodeinfo .comment_content").css("color", bz_color);
        var bzdate_color = form.find("#secodeinfo").attr("data-bzdate_color");
        if (bzdate_color)
          form.find("#secodeinfo .comment_date").css("color", bzdate_color);
        var bzdate_size = form.find("#secodeinfo").attr("data-bzdate_size");
        if (bzdate_size)
          form
            .find("#secodeinfo .comment_date")
            .css("font-size", bzdate_size + "px");
    ...
    setTimeout(function () {
      jQuery(".position-follow").each(function () {
        ...
        if (jQuery(this).hasClass("mobile_follow") && body_width > 992) {
          ...
          body_width < 992 &&
          !jQuery(this).hasClass("mobile_follow") &&
          !jQuery(this).hasClass("all_follow")
        ) {
          //default pc follow
          is_run = false;
        }
        ...
        if (is_run && jQuery(this).closest(".section-special").length == 0) {
          ...
          var scrtop_bottom =
            jQuery("#footer").offset().top * 1 - scrtop_threshold_height * 1;
          ...
          jQuery(window).on("scroll", function () {
            ...
            if (
              scrtop_tempScrTop > scrtop_threshold &&
              scrtop_isMoved === false
            ) {
              scrtop_isMoved = true;
              jQuery($this)
                .addClass("positionfixed0")
                .width(scrtop_threshold_width)
                .height(scrtop_threshold_height)
                .css("top", phantom_height + "px")
                .css("left", scrtop_threshold_left + "px");
              jQuery($this)
                .parent()
                .css("min-height", scrtop_threshold_height + "px");
              jQuery($this)
                .closest("section.section")
                .addClass("positionfixedTopindex");
            } else if (
              scrtop_tempScrTop <= scrtop_threshold &&
              scrtop_isMoved === true
            ) {
...
/* jquery-lazy: (https://5b6d6cca63736.t73.qifeiye.com/qfy-includes/js/jquery.lazy.min.js) */
