...
/* iphorm-plugin: (https://5b6d6cca63736.t73.qifeiye.com/qfy-content/plugins/qfy_form/js/jquery.iphorm.js) */
/*
...
function get_iphorm_phone(obj,e){
	...
	jQuery.post("https://5b6d6cca63736.t73.qifeiye.com/admin/admin-ajax.php",{"action":"tosendsms","phone":phone},function(response){
		if(response!="success"){
			label.html(label_text);
			if(phone){
...
;(function($) {
	$.iPhorm = function ($form, options) {
		...
		supportsSwfUpload = typeof swfobject === 'object'  && swfobject.hasFlashPlayerVersion('https://5b6d6cca63736.t73.qifeiye.com/qfy-content/cache/scripts/9.0.28'),
		...
		_this.submit = function () {
			 if(typeof jQuery.fn.ajaxSubmit=="undefined"){
				 jQuery.getScript( "../../plugins/qfy_form/js/jquery.form.min.js"/*tpa=https://5b6d6cca63736.t73.qifeiye.com/qfy-content/plugins/qfy_form/js/jquery.form.min.js*/,function(){
					 _this._submit();
				 });
			 }else{
				 _this._submit();
						...
						if (response.type == 'success') {
							...
							if (typeof response.redirect === 'string') {
								...
								if($pop.length >0 && $pop.val()==""){
									var success_htm = '<div style="text-align:center;" ><img class="qfy_pop_checkedimg" src="../../../FeiEditor/images/bitcms/check.png"/*tpa=https://5b6d6cca63736.t73.qifeiye.com/FeiEditor/images/bitcms/check.png*/ style="margin-top:20px;margin-bottom:20px;" /><div style="padding-bottom:20px;">'+response.data+'</div></div>';
							...
							if(response.data && response.type == 'error'){
								...
								if(top!=self){
									...
									if (typeof response.redirect === 'string') {
										...
										if($pop.length >0 && $pop.val()==""){
											var success_htm = '<div style="text-align:center;" ><img class="qfy_pop_checkedimg" src="../../../FeiEditor/images/bitcms/check.png"/*tpa=https://5b6d6cca63736.t73.qifeiye.com/FeiEditor/images/bitcms/check.png*/ style="margin-top:20px;margin-bottom:20px;" /><div style="padding-bottom:20px;font-family:微软雅黑;">'+response.data+'</div></div>';
											top.qfy_popinfo_fun(success_htm,settings.successMessageTimeout*1/3);
										}else{
											// Then fade in the success message
...
//            'file-upload-tick.png'/*tpa=https://5b6d6cca63736.t73.qifeiye.com/qfy-content/cache/scripts/file-upload-tick.png*/,
//            'captcha-refresh-icon.png'/*tpa=https://5b6d6cca63736.t73.qifeiye.com/qfy-content/cache/scripts/captcha-refresh-icon.png*/,
//            'default-loading.gif'/*tpa=https://5b6d6cca63736.t73.qifeiye.com/qfy-content/cache/scripts/default-loading.gif*/,
//            'error.png'/*tpa=https://5b6d6cca63736.t73.qifeiye.com/qfy-content/cache/scripts/error.png*/,
//            'success.png'/*tpa=https://5b6d6cca63736.t73.qifeiye.com/qfy-content/cache/scripts/success.png*/
...
/* jquery-form: (https://5b6d6cca63736.t73.qifeiye.com/qfy-includes/js/jquery/jquery.form.min.js) */
/*!
 * jQuery Form Plugin
...
/* jquery-smooth-scroll: (https://5b6d6cca63736.t73.qifeiye.com/qfy-content/plugins/qfy_form/js/jquery.smooth-scroll.min.js) */
